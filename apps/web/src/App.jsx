...
import GatewayInstallationPanel from "./components/gateway/GatewayInstallationPanel.jsx";
    ...
    if (activeSection === "devices") {
      return (
        <section className="resource-page">
            ...
            <section className="crud-grid">
              <form className="panel form-panel" onSubmit={saveDeviceForm}>
                ...
                <div className="form-grid">
                  ...
                  {deviceForm.manufacturer === "Axis" && <Field label="Token VAPIX da porta"><input value={deviceForm.doorToken || ""} onChange={(event) => setDeviceForm((current) => ({ ...current, doorToken: event.target.value }))} placeholder="Token retornado por axtdc:GetDoorList" /></Field>}
                  {deviceForm.manufacturer === "Suprema" && <div className="form-hint">Informe o endereco do servidor BioStar 2/BioStar X. A API REST nao conecta diretamente ao terminal Suprema.</div>}
          ...
          {deviceTab === "gateway" && (
            <GatewayInstallationPanel
              data={data}
              selectedTenant={selectedTenant}
              selectedTenantId={selectedTenantId}
              setSelectedTenantId={setSelectedTenantId}
              visibleCondominiums={visibleCondominiums}
              gatewayForm={gatewayForm}
              setGatewayForm={setGatewayForm}
              prepareGatewayInstallation={prepareGatewayInstallation}
              copyGatewayInstallCode={copyGatewayInstallCode}
              startLocalGatewayDeviceRegistration={startLocalGatewayDeviceRegistration}
